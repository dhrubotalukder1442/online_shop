    ...
    <div class="w-full max-w-md bg-white shadow-lg rounded-lg p-10">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="flex items-center justify-between">
                <a href="{{ route('register') }}" class="px-6 py-3 text-lg bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition font-semibold text-center w-full mr-2">
                    {{ __('Register') }}
                </a>

                <button type="submit" class="px-6 py-3 text-lg bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition font-semibold w-full ml-2">
                    {{ __('Log in') }}
                </button>
            </div>
